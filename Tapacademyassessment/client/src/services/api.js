...
export const AttendanceApi = {
    ...
    myHistory: (month) => api.get('/api/attendance/my-history', { params: { month } }),
    mySummary: (month) => api.get('/api/attendance/my-summary', { params: { month } }),
    today: () => api.get('/api/attendance/today'),
};
export const ManagerApi = {
    all: (params) => api.get('/api/attendance/all', { params }),
    todayStatus: () => api.get('/api/attendance/today-status'),
    users: () => api.get('/api/users'),
    export: (params) => api.get('/api/attendance/export', { params, responseType: 'text' }),
    employee: (id, params) => api.get(`/api/attendance/employee/${id}`, { params }),
